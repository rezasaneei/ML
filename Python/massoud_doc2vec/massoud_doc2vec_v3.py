...
docs = []
with open('movie_lines.txt', encoding='utf8') as f:
...
with open('plot_summaries.txt', newline='', encoding='utf8') as f:
...
model = Doc2Vec(documents, dm = 0, alpha = 0.025, min_alpha = 0.001, min_count = 1, vector_size = 500, workers=7, epochs = 10)
